...
updated_edg_labels = [];
updated_iot_edges = [];
gs_iots = ["Main_IoT","N2", "N3","N4", "N5","N6", "N7","N8", "N9","N10", "N11", "GS1"];
sats = ["Satellite 1", "Satellite 2", "Satellite 3","Satellite 4","Satellite 5","Satellite 6","Satellite 7", ...
    "Satellite 8","Satellite 9","Satellite 10","Satellite 11","Satellite 12"];
...
highlight(p, "Main_IoT", 'NodeColor', 'r', 'MarkerSize', 15);
highlight(p, "GS1", 'NodeColor', 'g', 'MarkerSize', 15);
grid on;
...
% Highlight source and target nodes
highlight(p, "Main_IoT", 'NodeColor', 'r', 'MarkerSize', 12);
highlight(p, "GS1", 'NodeColor', 'g', 'MarkerSize', 12);
grid on;
